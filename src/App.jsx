    ...
    <div style={{ background: BG, color: FG, fontFamily: '"Barlow Condensed", "Oswald", "Arial Narrow", sans-serif', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <header style={{
        ...
        <a href="#" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
          <img src="/logo.png" alt="YYZ Concrete" style={{ height: mobile ? 48 : 60, width: 'auto', display: 'block', mixBlendMode: 'multiply' }} />
        </a>
        {!mobile && (
      ...
      <footer style={{ background: '#0a0a0a', color: '#f0eee9', padding: mobile ? '40px 20px 24px' : '80px 64px 40px' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          <img src="/logo-dark.png" alt="YYZ Concrete" style={{ height: mobile ? 100 : 180, width: 'auto', display: 'block', marginBottom: mobile ? 24 : 40 }} />
