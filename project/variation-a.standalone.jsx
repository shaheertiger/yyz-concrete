  ...
  return (
    <div style={{ background: bg, color: fg, fontFamily: '"Barlow Condensed", "Oswald", "Arial Narrow", sans-serif', minHeight: '100%', overflow: 'hidden' }}>
      ...
      <section style={{ position: 'relative', height: 720, overflow: 'hidden', background: '#0a0a0a' }}>
        <img src={window.__resources.imgMixer} alt=""
      ...
      <section style={{ maxWidth: 1400, margin: '0 auto', padding: '120px 64px 80px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 0, border: `1px solid ${border}` }}>
          {[
            { n: '01', title: 'Ready-Mix Delivery', specs: ['15 – 50 MPa', 'Same-day dispatch', 'Onsite slump test'], img: window.__resources.imgSlab },
            { n: '02', title: 'Concrete Pumping', specs: ['32 m + 38 m boom', 'Line pumps to 200 m', 'High-rise rated'], img: window.__resources.imgPump },
            { n: '03', title: 'Volumetric / Mix-On-Site', specs: ['No short-load fee', 'Variable PSI', '4–10 m³ per truck'], img: window.__resources.imgMini },
          ].map((s, i) => (
