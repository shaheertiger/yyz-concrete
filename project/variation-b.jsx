...
function VariationB({ accent = '#FF6A00' }) {
  ...
  return (
    <div style={{ background: bg, color: fg, fontFamily: '"Archivo", "Helvetica Neue", Helvetica, sans-serif', minHeight: '100%', overflow: 'hidden' }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Archivo:wght@400;500;600;700;800;900&family=Archivo+Black&family=IBM+Plex+Mono:wght@400;500;600&display=swap');
      ...
      <section style={{ padding: '64px 40px 0', position: 'relative' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: 12, marginTop: 56 }}>
          <div style={{ aspectRatio: '16/9', overflow: 'hidden', position: 'relative' }}>
            <img src="https://images.unsplash.com/photo-1517089596392-fb9a9033e05b?w=1800&q=85" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          ...
          <div style={{ aspectRatio: '4/5', overflow: 'hidden', position: 'relative' }}>
            <img src="https://images.unsplash.com/photo-1564013434775-f71db0030976?w=900&q=85" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
